...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-gradient-neutral" id="sidenav-main">
    <div class="container-fluid">
        ...
        <a class="navbar-brand p-0" href="http://senaicurso.com.br">
            <img src="<?php echo e(asset('/img/brand/logo_perfectpay_h30.png')); ?>" alt='PerfectPay'>
        </a>
        <!-- Collapse -->
...
<?php /**PATH /var/www/html/CursoLaravel/resources/views/Layouts/Menu.blade.php ENDPATH**/ ?>